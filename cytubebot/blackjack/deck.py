...
class Deck:
    ...
    def _get_full_shuffled_deck(self) -> None:
        ...
        suits = random.SystemRandom().sample(['hearts', 'diamonds', 'spades', 'clubs'], 4)
        self.deck = [Card(suit, value) for value in random.SystemRandom().sample(range(1, 14), 13) for suit in suits]
